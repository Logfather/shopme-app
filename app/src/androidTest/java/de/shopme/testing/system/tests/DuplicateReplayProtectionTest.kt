...
import de.shopme.testing.system.scenarios.DuplicateReplayProtectionScenario
...
class DuplicateReplayProtectionTest {
    ...
    @Test
    fun duplicateReplayProtectionScenario_runsSuccessfully() = runBlocking<Unit> {
        ...
        DuplicateReplayProtectionScenario()
            .run(
                deviceA = deviceA,
                deviceB = deviceB,
