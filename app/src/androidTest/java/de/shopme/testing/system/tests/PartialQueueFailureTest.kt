...
import de.shopme.testing.system.scenarios.PartialQueueFailureScenario
...
class PartialQueueFailureTest {
    ...
    @Test
    fun partialQueueFailureScenario_runsSuccessfully() = runBlocking<Unit> {
