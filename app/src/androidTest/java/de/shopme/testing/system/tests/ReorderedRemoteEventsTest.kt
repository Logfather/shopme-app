...
import de.shopme.testing.system.scenarios.ReorderedRemoteEventsScenario
...
class ReorderedRemoteEventsTest {
    ...
    @Test
    fun reorderedRemoteEventsScenario_runsSuccessfully() = runBlocking<Unit> {
