...
import de.shopme.testing.system.scenarios.UpdateVsDeleteScenario
...
class UpdateVsDeleteTest {
    ...
    @Test
    fun updateVsDeleteScenario_runsSuccessfully() = runBlocking<Unit> {
