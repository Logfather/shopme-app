...
import de.shopme.testing.system.scenarios.ConcurrentUpdateStormScenario
...
class ConcurrentUpdateStormTest {
    ...
    @Test
    fun concurrentUpdateStormScenario_runsSuccessfully() = runBlocking<Unit> {
