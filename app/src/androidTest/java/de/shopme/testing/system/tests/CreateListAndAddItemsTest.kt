...
import de.shopme.testing.system.scenario.CreateListAndAddItemsScenario
...
class CreateListAndAddItemsTest {
    ...
    @Test
    fun createListAndAddItemsScenario_runsSuccessfully() = runTest {
        ...
        runner.runScenario(
            scenario = CreateListAndAddItemsScenario(),
            context = context
        )
    }
}