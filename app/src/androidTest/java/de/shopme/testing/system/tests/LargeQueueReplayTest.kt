...
import de.shopme.testing.system.scenarios.LargeQueueReplayScenario
...
class LargeQueueReplayTest {
    ...
    @Test
    fun largeQueueReplayScenario_runsSuccessfully() = runBlocking<Unit> {
