...
import de.shopme.testing.system.scenarios.StaleDeviceReconnectAfterLongOfflineScenario
...
class StaleDeviceReconnectAfterLongOfflineTest {
    ...
    @Test
    fun staleDeviceReconnectAfterLongOfflineScenario_runsSuccessfully() = runBlocking<Unit> {
        ...
        StaleDeviceReconnectAfterLongOfflineScenario()
            .run(
                deviceA = deviceA,
                deviceB = deviceB,
