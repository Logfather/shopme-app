...
import de.shopme.testing.system.scenario.UpdateExistingItemScenario
...
class UpdateExistingItemTest {
    ...
    @Test
    fun updateExistingItemScenario_runsSuccessfully() = runTest {
        ...
        runner.runScenario(
            scenario = UpdateExistingItemScenario(),
            context = context
        )
    }
}