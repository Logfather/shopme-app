...
import de.shopme.testing.system.scenarios.ConcurrentDeleteStormScenario
...
class ConcurrentDeleteStormTest {
    ...
    @Test
    fun concurrentDeleteStormScenario_runsSuccessfully() = runBlocking<Unit> {
